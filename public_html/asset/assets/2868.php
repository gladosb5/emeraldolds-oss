<roblox xmlns:xmime="http://www.w3.org/2005/05/xmlmime" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.emeraldolds.glados.pro/roblox.xsd" version="4">
	...
	<Item class="Model" referent="RBX0">
		<Properties>
			...
			<string name="Name">School Bus</string>
		...
		<Item class="Part" referent="RBX80">
			...
			<Item class="BodyForce" referent="RBX81">
				<Properties>
		...
		<Item class="Part" referent="RBX105">
			<Properties>
				...
				<bool name="Locked">false</bool>
				<token name="Material">256</token>
				<string name="Name">GoButton</string>
				<float name="Reflectance">0</float>
				<float name="RightParamA">-0.5</float>
				<float name="RightParamB">0.5</float>
				<token name="RightSurface">0</token>
			...
			<Item class="Script" referent="RBX106">
				<Properties>
					...
					<ProtectedString name="Source">local engine = script.Parent.Parent.Engine
...
function onTouched(hit)
	...
	if humanoid~=nil and debounce == false then
		...
		bodyforce.force = Vector3.new(-1000000,0,0)
		wait(6)
...
script.Parent.Touched:connect(onTouched)
		...
		<Item class="Part" referent="RBX155">
			...
			<Item class="SpecialMesh" referent="RBX156">
				<Properties>
					<token name="LODX">2</token>
					<token name="LODY">2</token>
					<Content name="MeshId"><null></null></Content>
