<roblox xmlns:xmime="http://www.w3.org/2005/05/xmlmime" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.emeraldolds.glados.pro/roblox.xsd" version="4">
	...
	<Item class="Tool" referent="RBX0">
		<Properties>
			...
			<string name="Name">DancePotion</string>
			<Content name="TextureId"><url>http://www.emeraldolds.glados.pro/asset/?id=27808126</url></Content>
		...
		<Item class="Part" referent="RBX1">
			...
			<Item class="SpecialMesh" referent="RBX2">
				<Properties>
					...
					<Content name="MeshId"><url>http://www.emeraldolds.glados.pro/asset/?id=27808002</url></Content>
					...
					<Content name="TextureId"><url>http://www.emeraldolds.glados.pro/asset/?id=27808058</url></Content>
			...
			<Item class="Sound" referent="RBX3">
				<Properties>
					...
					<Content name="SoundId"><url>http://www.emeraldolds.glados.pro/asset/?id=27808972</url></Content>
			...
			<Item class="Sound" referent="RBX4">
				<Properties>
					...
					<int name="PlayCount">-1</int>
					<bool name="PlayOnRemove">false</bool>
					<Content name="SoundId"><url>http://www.emeraldolds.glados.pro/asset/?id=27809960</url></Content>
					<float name="Volume">0.5</float>
					<bool name="archivable">true</bool>
				</Properties>
			</Item>
		...
		<Item class="Animation" referent="RBX5">
			<Properties>
				<Content name="AnimationId"><url>http://www.emeraldolds.glados.pro/Asset?ID=27789359</url></Content>
