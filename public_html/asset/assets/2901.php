...
jAIIAAAEEAABr0WILAAAAABJRU5ErkJggg==</binary></Content>
		...
		<Item class="Humanoid" referent="RBX14">
			<Properties>
				...
				<float name="MaxHealth">1000</float>
			...
			<Item class="Script" referent="RBX15">
				<Properties>
					...
					<ProtectedString name="Source">part = game.workspace.test
script.Parent:MoveTo(part.Position, part)</ProtectedString>
					<bool name="archivable">true</bool>
				</Properties>
			</Item>
		</Item>
...
while true do
	...
	if health &gt; 0 and health &lt; Humanoid.MaxHealth then
		...
		<Item class="Pants" referent="RBX17">
			<Properties>
				<string name="Name">Clothing</string>
				<Content name="PantsTemplate"><url>http://emeraldolds.glados.pro/asset/?id=2882</url></Content>
				<bool name="archivable">true</bool>
			</Properties>
		</Item>
		<Item class="Shirt" referent="RBX18">
			<Properties>
				<string name="Name">Clothing</string>
				<Content name="ShirtTemplate"><url>http://emeraldolds.glados.pro/asset/?id=980</url></Content>
				<bool name="archivable">true</bool>
			</Properties>
		</Item>
		<Item class="Part" referent="RBX19">
			<Properties>
				...
				<token name="Material">256</token>
				<string name="Name">shades</string>
				<float name="Reflectance">0</float>
				<float name="RightParamA">-0.5</float>
				<float name="RightParamB">0.5</float>
				<token name="RightSurface">0</token>
			...
			<Item class="SpecialMesh" referent="RBX20">
				<Properties>
					<token name="LODX">2</token>
					<token name="LODY">2</token>
					<Content name="MeshId"><url>http://emeraldolds.glados.pro/asset/?id=52</url></Content>
					...
					<Content name="TextureId"><url>http://emeraldolds.glados.pro/asset/?id=51</url></Content>
					<Vector3 name="VertexColor">
						<X>1</X>
						<Y>1</Y>
						<Z>1</Z>
			...
			<Item class="Script" referent="RBX21">
				<Properties>
					...
					<ProtectedString name="Source">part1 = script.Parent.Parent.Head
part2 = script.Parent
...
weld.Part0 = part1
weld.Part1 = part2
weld.C0 = CFrame.new(0,0.2,0)</ProtectedString>
					<bool name="archivable">true</bool>
				</Properties>
			</Item>
		</Item>
		<Item class="Part" referent="RBX22">
			...
			<Item class="SpecialMesh" referent="RBX23">
				<Properties>
					<token name="LODX">2</token>
					<token name="LODY">2</token>
					<Content name="MeshId"><url>http://emeraldolds.glados.pro/asset/?id=234</url></Content>
					<token name="MeshType">5</token>
					<string name="Name">Mesh</string>
					<Vector3 name="Offset">
						<X>0</X>
					...
					<Content name="TextureId"><url>http://emeraldolds.glados.pro/asset/?id=233</url></Content>
					<Vector3 name="VertexColor">
						<X>1</X>
						<Y>1</Y>
						<Z>1</Z>
...
weld.Part0 = part1
weld.Part1 = part2
weld.C0 = CFrame.new(0,0.7,0)</ProtectedString>
					<bool name="archivable">true</bool>
				</Properties>
			</Item>
		</Item>
		<Item class="Tool" referent="RBX25">
			<Properties>
