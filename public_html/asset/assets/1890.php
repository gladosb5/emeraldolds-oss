	...
	<Item class="Model" referent="RBX0">
		...
		<Item class="Part" referent="RBX1">
			<Properties>
				...
				<string name="Name">Pillar</string>
			...
			<Item class="Decal" referent="RBX2">
				<Properties>
					...
					<Content name="Texture"><url>http://emeraldolds.glados.pro/asset/?id=1834</url></Content>
					<bool name="archivable">true</bool>
				</Properties>
			</Item>
			<Item class="Decal" referent="RBX3">
				<Properties>
					...
					<float name="Shiny">20</float>
					<float name="Specular">0</float>
					<Content name="Texture"><url>http://emeraldolds.glados.pro/asset/?id=1876</url></Content>
					<bool name="archivable">true</bool>
				</Properties>
			</Item>
		</Item>
		<Item class="Part" referent="RBX4">
			...
			<Item class="Decal" referent="RBX5">
				<Properties>
					...
					<float name="Shiny">20</float>
					<float name="Specular">0</float>
					<Content name="Texture"><url>http://emeraldolds.glados.pro/asset/?id=1826</url></Content>
					<bool name="archivable">true</bool>
				</Properties>
			</Item>
			<Item class="Decal" referent="RBX6">
				<Properties>
					...
					<float name="Shiny">20</float>
					<float name="Specular">0</float>
					<Content name="Texture"><url>http://emeraldolds.glados.pro/asset/?id=1882</url></Content>
					<bool name="archivable">true</bool>
				</Properties>
			</Item>
		</Item>
		<Item class="Part" referent="RBX7">
			<Properties>
				<bool name="Anchored">false</bool>
				<float name="BackParamA">-0.300000012</float>
				<float name="BackParamB">0.300000012</float>
				...
				<token name="FormFactor">1</token>
				<float name="Friction">0.300000012</float>
				<float name="FrontParamA">-0.300000012</float>
				<float name="FrontParamB">0.300000012</float>
		...
		<Item class="Part" referent="RBX8">
			<Properties>
				...
				<bool name="Locked">false</bool>
				<token name="Material">256</token>
				<string name="Name">Smooth Block</string>
				<float name="Reflectance">0</float>
			...
			<Item class="Decal" referent="RBX9">
				<Properties>
					...
					<float name="Shiny">20</float>
					<float name="Specular">0</float>
					<Content name="Texture"><url>http://emeraldolds.glados.pro/asset/?id=1880</url></Content>
					<bool name="archivable">true</bool>
				</Properties>
			</Item>
		</Item>
		<Item class="Part" referent="RBX10">
			<Properties>
				...
				<token name="FormFactor">1</token>
				<float name="Friction">0.300000012</float>
				<float name="FrontParamA">-0.100000001</float>
				<float name="FrontParamB">0.100000001</float>
				<token name="FrontSurface">7</token>
				<token name="FrontSurfaceInput">3</token>
				<float name="LeftParamA">-0.5</float>
				<float name="LeftParamB">0.5</float>
				<token name="LeftSurface">0</token>
				<token name="LeftSurfaceInput">0</token>
		...
		<Item class="Part" referent="RBX18">
			<Properties>
				...
				<token name="TopSurfaceInput">4</token>
				<float name="Transparency">0</float>
				<Vector3 name="Velocity">
					<X>0</X>
					<Y>0</Y>
		...
		<Item class="Model" referent="RBX19">
			...
			<Item class="Part" referent="RBX24">
				<Properties>
					...
					<token name="BackSurface">0</token>
					<token name="BackSurfaceInput">0</token>
					<float name="BottomParamA">3.06368995</float>
					<float name="BottomParamB">0.5</float>
					<token name="BottomSurface">0</token>
					<token name="BottomSurfaceInput">0</token>
					<int name="BrickColor">148</int>
					...
					<float name="RightParamA">-0.300000012</float>
					<float name="RightParamB">0.300000012</float>
					<token name="RightSurface">7</token>
					...
					<float name="TopParamA">8.33757973</float>
					<float name="TopParamB">0.5</float>
					<token name="TopSurface">0</token>
					<token name="TopSurfaceInput">0</token>
					<float name="Transparency">0</float>
				...
				<Item class="Decal" referent="RBX25">
					<Properties>
						...
						<float name="Shiny">20</float>
						<float name="Specular">0</float>
						<Content name="Texture"><url>http://emeraldolds.glados.pro/asset/?id=1874</url></Content>
						<bool name="archivable">true</bool>
					</Properties>
				</Item>
			</Item>
