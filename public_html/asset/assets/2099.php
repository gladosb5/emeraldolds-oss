	...
	<Item class="Tool" referent="RBX0">
		<Properties>
			...
			<CoordinateFrame name="Grip">
				...
				<Y>0</Y>
				<Z>-1.29999995</Z>
				<R00>0.000123821184</R00>
				<R01>-0.294905365</R01>
				<R02>0.955526531</R02>
				<R10>0.994947374</R10>
				<R11>0.0959692076</R11>
				<R12>0.029490171</R12>
				<R20>-0.100397922</R20>
				<R21>0.950694919</R21>
				<R22>0.293427199</R22>
		...
		<Item class="Part" referent="RBX1">
			<Properties>
				...
				<CoordinateFrame name="CFrame">
					...
					<R02>-1.86264515e-008</R02>
					<R10>1.86264515e-008</R10>
					<R11>0</R11>
					<R12>1.00000012</R12>
					<R20>2.98023224e-008</R20>
					<R21>1.00000012</R21>
					<R22>0</R22>
				</CoordinateFrame>
			...
			<Item class="SpecialMesh" referent="RBX2">
				<Properties>
					...
					<Content name="MeshId"><url>http://www.emeraldolds.glados.pro/asset?id=12221344</url></Content>
					...
					<Content name="TextureId"><url>http://www.emeraldolds.glados.pro/asset?id=12222613</url></Content>
		...
		<Item class="LocalScript" referent="RBX3">
			<Properties>
				...
				<ProtectedString name="Source">local vPlayer = game.Players.LocalPlayer
...
function onButton1Down(mouse)
	...
	if Target and Target:IsA(&quot;BasePart&quot;) and not Target.Locked then
		...
		if not Tool:findFirstChild(&quot;PewPew&quot;) then
	...
	<Item class="Tool" referent="RBX5">
		...
		<Item class="Part" referent="RBX6">
			<Properties>
				...
				<CoordinateFrame name="CFrame">
					...
					<Z>-0.899997413</Z>
					<R00>-1.00000894</R00>
					<R01>-8.56833893e-008</R01>
					<R02>5.58810633e-008</R02>
					<R10>-8.56831406e-008</R10>
					<R11>1.00000679</R11>
					<R12>7.45068718e-009</R12>
					<R20>-5.58808324e-008</R20>
					<R21>7.45066586e-009</R21>
					<R22>-1.00000525</R22>
				</CoordinateFrame>
			...
			<Item class="SpecialMesh" referent="RBX7">
				<Properties>
					<token name="LODX">2</token>
					<token name="LODY">2</token>
					<Content name="MeshId"><url>http://www.emeraldolds.glados.pro/asset?id=12221451</url></Content>
					<token name="MeshType">5</token>
					<string name="Name">Mesh</string>
					<Vector3 name="Offset">
						<X>0</X>
					...
					<Content name="TextureId"><url>http://www.emeraldolds.glados.pro/asset?id=12223896</url></Content>
					<Vector3 name="VertexColor">
						<X>1</X>
						<Y>1</Y>
						<Z>1</Z>
		...
		<Item class="LocalScript" referent="RBX8">
			<Properties>
				...
				<Content name="LinkedSource"><null></null></Content>
				<string name="Name">LocalScript</string>
				<ProtectedString name="Source">local SBox = Instance.new(&quot;SelectionBox&quot;)
...
function onEquippedLocal(mouse)
	SBox.Color = BrickColor.new(Color3.new(1, 0.4, 0))
	SBox.Parent = vPlayer.PlayerGui
	mouse.Icon = &quot;rbxasset://textures\\HammerCursor.png&quot;
...
script.Parent.Equipped:connect(onEquipped)
	...
	<Item class="Tool" referent="RBX10">
		<Properties>
			<bool name="Enabled">true</bool>
			<CoordinateFrame name="Grip">
				<X>0</X>
		...
		<Item class="Part" referent="RBX11">
			...
			<Item class="SpecialMesh" referent="RBX12">
				<Properties>
					<token name="LODX">2</token>
					<token name="LODY">2</token>
					<Content name="MeshId"><url>http://www.emeraldolds.glados.pro/asset?id=21342275</url></Content>
					<token name="MeshType">5</token>
					<string name="Name">Mesh</string>
					<Vector3 name="Offset">
						<X>0</X>
			...
			<Item class="Weld" referent="RBX17">
				<Properties>
					<CoordinateFrame name="C0">
						<X>5.25072437e-006</X>
						<Y>-9.04979558e-008</Y>
...
function onButton1Down(mouse)
	local Target = mouse.Target
	if Target and Target:IsA(&quot;BasePart&quot;) and not Target.Locked and (Target.Position - Tool.Handle.Position).magnitude &lt; 60 then
		Orig = Target
		Select = Orig--:clone()
...
function onMouseMove(mouse)
	if Dragger then
		...
		if Target and Target:IsA(&quot;BasePart&quot;) and not Target.Locked and (Target.Position - Tool.Handle.Position).magnitude &lt; 60 then
			mouse.Icon = &quot;rbxasset://textures\\DragCursor.png&quot;
		elseif Target and Target:IsA(&quot;BasePart&quot;) and not Target.Locked and (Target.Position - Tool.Handle.Position).magnitude &gt;= 60 then
