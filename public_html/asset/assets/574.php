<roblox xmlns:xmime="http://www.w3.org/2005/05/xmlmime" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.roblox.com/roblox.xsd" version="4">
	...
	<Item class="Tool" referent="RBX0">
		<Properties>
			...
			<Content name="TextureId"><url>http://www.emeraldolds.glados.pro/asset/?id=17269609</url></Content>
		...
		<Item class="Part" referent="RBX1">
			<Properties>
				...
				<CoordinateFrame name="CFrame">
					...
					<Z>0.5</Z>
					<R00>-1</R00>
					<R01>-5.19329011e-018</R01>
					<R02>-8.41575954e-018</R02>
					<R10>-5.19329011e-018</R10>
					<R11>1</R11>
					<R12>5.19329011e-018</R12>
					<R20>8.41575954e-018</R20>
					<R21>5.19329011e-018</R21>
					<R22>-1</R22>
				</CoordinateFrame>
			...
			<Item class="SpecialMesh" referent="RBX2">
				<Properties>
					...
					<Content name="MeshId"><url>http://www.emeraldolds.glados.pro/asset/?id=1374162</url></Content>
		...
		<Item class="Part" referent="RBX8">
			<Properties>
				...
				<CoordinateFrame name="CFrame">
					...
					<Z>0.5</Z>
					<R00>-1</R00>
					<R01>-1.7810368e-013</R01>
					<R02>-1.18916888e-016</R02>
					<R10>-1.7810368e-013</R10>
					<R11>1</R11>
					<R12>1.8044805e-013</R12>
					<R20>1.18916888e-016</R20>
					<R21>1.8044805e-013</R21>
					<R22>-1</R22>
				</CoordinateFrame>
				<bool name="CanCollide">true</bool>
				<bool name="DraggingV1">false</bool>
			...
			<Item class="Decal" referent="RBX9">
				<Properties>
					...
					<Content name="Texture"><url>http://www.emeraldolds.glados.pro/asset/?id=4487034</url></Content>
					<bool name="archivable">true</bool>
				</Properties>
			</Item>
		...
		<Item class="Script" referent="RBX13">
			<Properties>
				...
				<ProtectedString name="Source">function Weldnow()	
	...
	w3.C0 = CFrame.fromEulerAnglesXYZ(0, 0, 0) * CFrame.new(0, -.25, 0)
...
script.Parent.Equipped:connect(Weldnow)
		...
		<Item class="Script" referent="RBX14">
			<Properties>
				...
				<ProtectedString name="Source">local player = nil
...
player = tool.Parent
tool.GripPos = Vector3.new(1.5, -0.3, 0)
tool.GripUp = Vector3.new(0, 1, -.5)
tool.Handle.DrinkSound.Volume = .3
...
if v:IsA(&quot;Part&quot;) then
v:BreakJoints()
v.Velocity = Vector3.new(math.random(-50, 50), math.random(50, 100), math.random(-50, 50))
end
end
...
tool.GripUp = Vector3.new(0, 1, 0)
		...
		<Item class="Part" referent="RBX15">
			...
			<Item class="CylinderMesh" referent="RBX16">
				<Properties>
