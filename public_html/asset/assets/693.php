<roblox xmlns:xmime="http://www.w3.org/2005/05/xmlmime" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.emeraldolds.glados.pro/roblox.xsd" version="4">
	...
	<Item class="Hat" referent="RBX0">
		<Properties>
			...
			<string name="Name">BunnyEars</string>
		</Properties>
		<Item class="Part" referent="RBX1">
			...
			<Item class="SpecialMesh" referent="RBX2">
				<Properties>
					...
					<Content name="MeshId"><url>http://emeraldolds.glados.pro/asset/?id=692</url></Content>
					...
					<Content name="TextureId"><url>http://emeraldolds.glados.pro/asset/?id=691</url></Content>
