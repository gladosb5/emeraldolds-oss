...
function incCounter(player)
	local countername = &quot;NormalSwordNumFound&quot;
	print(&quot;incCounter: &quot; .. countername .. &quot; for &quot; .. player.Name) 
	local f = player:LoadNumber(countername)
	if (f == nil) then f = 0 end
	f = f + 1
	player:SaveNumber(countername, f)
end
...
-- record that the player started this life with this sword
while(script.Parent.Parent == nil) do wait(.1) end
if (script.Parent.Parent.className == &quot;Backpack&quot;) then
	--incCounter(script.Parent.Parent.Parent)
end
