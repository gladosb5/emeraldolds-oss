	...
	<Item class="Model" referent="RBX0">
		...
		<Item class="Part" referent="RBX1">
			<Properties>
				...
				<string name="Name">Part12</string>
			...
			<Item class="CylinderMesh" referent="RBX2">
				<Properties>
		...
		<Item class="Part" referent="RBX3">
			<Properties>
				...
				<bool name="Locked">false</bool>
				<token name="Material">256</token>
				<string name="Name">Part1234</string>
				<float name="Reflectance">0</float>
				<float name="RightParamA">-0.5</float>
				<float name="RightParamB">0.5</float>
				<token name="RightSurface">0</token>
			...
			<Item class="CylinderMesh" referent="RBX4">
				<Properties>
					<float name="Bevel">0</float>
					<float name="Bevel Roundness">0</float>
					<float name="Bulge">0</float>
		...
		<Item class="Part" referent="RBX5">
			...
			<Item class="CylinderMesh" referent="RBX6">
				<Properties>
					<float name="Bevel">0</float>
					<float name="Bevel Roundness">0</float>
					<float name="Bulge">0</float>
		...
		<Item class="Part" referent="RBX10">
			...
			<Item class="CylinderMesh" referent="RBX11">
				<Properties>
					<float name="Bevel">0</float>
					<float name="Bevel Roundness">0</float>
					<float name="Bulge">0</float>
		...
		<Item class="Seat" referent="RBX13">
			<Properties>
				<bool name="Anchored">false</bool>
				<float name="BackParamA">-0.5</float>
				<float name="BackParamB">0.5</float>
		...
		<Item class="Part" referent="RBX18">
			...
			<Item class="CylinderMesh" referent="RBX19">
				<Properties>
					<float name="Bevel">0</float>
					<float name="Bevel Roundness">0</float>
					<float name="Bulge">0</float>
		...
		<Item class="VelocityMotor" referent="RBX22">
			<Properties>
			...
			<Item class="VelocityMotor" referent="RBX23">
				<Properties>
					<CoordinateFrame name="C0">
						<X>0</X>
						<Y>0</Y>
				...
				<Item class="VelocityMotor" referent="RBX24">
					<Properties>
						<CoordinateFrame name="C0">
							<X>0</X>
							<Y>0</Y>
					...
					<Item class="VelocityMotor" referent="RBX25">
						...
						<Item class="VelocityMotor" referent="RBX26">
							<Properties>
								<CoordinateFrame name="C0">
									<X>0</X>
									<Y>0</Y>
							...
							<Item class="VelocityMotor" referent="RBX27">
								<Properties>
									<CoordinateFrame name="C0">
										<X>0</X>
										<Y>0</Y>
								...
								<Item class="VelocityMotor" referent="RBX28">
									<Properties>
										<CoordinateFrame name="C0">
											<X>0</X>
											<Y>0</Y>
									...
									<Item class="VelocityMotor" referent="RBX29">
										<Properties>
											<CoordinateFrame name="C0">
												<X>0</X>
												<Y>0</Y>
										...
										<Item class="VelocityMotor" referent="RBX30">
											<Properties>
												<CoordinateFrame name="C0">
													<X>0</X>
													<Y>0</Y>
											...
											<Item class="VelocityMotor" referent="RBX31">
												<Properties>
													<CoordinateFrame name="C0">
														<X>0</X>
														<Y>0</Y>
