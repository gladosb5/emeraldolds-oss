...
wait(0.5) 
		...
		<Item class="Humanoid" referent="RBX9">
			<Properties>
				<float name="Health">100</float>
				<float name="MaxHealth">10000</float>
		...
		<Item class="Part" referent="RBX10">
			...
			<Item class="Script" referent="RBX11">
				<Properties>
					...
					<Content name="LinkedSource"><null></null></Content>
					<string name="Name">Script</string>
					<ProtectedString name="Source">function getPlayer(humanoid)
...
function onTouch(part)
	...
	player.Character = game.Workspace.BeWii
end
