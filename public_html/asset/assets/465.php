	...
	<Item class="Part" referent="RBX0">
		...
		<Item class="Part" referent="RBX1">
			...
			<Item class="Decal" referent="RBX2">
				<Properties>
					...
					<Content name="Texture"><url>http://www.emeraldolds.glados.pro/asset/?id=33025721</url></Content>
					<bool name="archivable">true</bool>
				</Properties>
			</Item>
			<Item class="BlockMesh" referent="RBX3">
				<Properties>
		...
		<Item class="Script" referent="RBX4">
			<Properties>
				...
				<ProtectedString name="Source">debounce = true
