		...
		<Item class="Model" referent="RBX19">
			...
			<Item class="Model" referent="RBX20">
				<Properties>
					...
					<string name="Name">Toilet</string>
					<Ref name="PrimaryPart">RBX21</Ref>
					<bool name="archivable">true</bool>
				</Properties>
				<Item class="Part" referent="RBX22">
					...
					<Item class="Texture" referent="RBX23">
						<Properties>
							<token name="Face">1</token>
							<string name="Name">flush</string>
							<float name="Shiny">20</float>
							<float name="Specular">0</float>
							<float name="StudsPerTileU">4</float>
							<float name="StudsPerTileV">4</float>
							<Content name="Texture"><binary>/9j/4AAQSkZJRgABAQEAYABgAAD/4QAWRXhpZgAASUkqAAgAAAAAAAAAAAD/2wBDAAgGBgcG
...
MjIyMjIyMjIyMjIyMjIyMjIyMjL/wAARCACZANEDASIAAhEBAxEB/8QAHwAAAQUBAQEBAQEA
...

...
RQAUUUUAFFFFABRRRQAUUUUAFFFFABRRRQAUUUUAFFFFABRRRQAUUUUAFFFFABRRRQAUUUUA
FFFFABRRRQAUUUUAFFFFABRRRQAUUUUAFFFFABRRRQAUUUUAFFFFABRRRQAUUUUAFFFFABRR
RQAUUUUAFFFFABRRRQAUUUUAFFFFABRRRQAUUUUAFFFFAH//2Q==</binary></Content>
							<bool name="archivable">true</bool>
						</Properties>
					</Item>
				</Item>
