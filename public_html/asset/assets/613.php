<roblox xmlns:xmime="http://www.w3.org/2005/05/xmlmime" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.roblox.com/roblox.xsd" version="4">
	...
	<Item class="Model" referent="RBX0">
		<Properties>
			...
			<string name="Name">Child on Skateboard</string>
		...
		<Item class="Model" referent="RBX1">
			...
			<Item class="Part" referent="RBX11">
				<Properties>
					...
					<float name="BackParamA">-0.5</float>
					<float name="BackParamB">0.5</float>
					<token name="BackSurface">6</token>
					<token name="BackSurfaceInput">0</token>
					<float name="BottomParamA">-0.300000012</float>
					<float name="BottomParamB">0.300000012</float>
					<token name="BottomSurface">1</token>
		...
		<Item class="Model" referent="RBX12">
			...
			<Item class="Part" referent="RBX13">
				<Properties>
					...
					<token name="FrontSurface">0</token>
					<token name="FrontSurfaceInput">0</token>
					<float name="LeftParamA">-0.600000024</float>
					<float name="LeftParamB">0.600000024</float>
			...
			<Item class="Part" referent="RBX14">
				<Properties>
					...
					<string name="Name">Part</string>
					<float name="Reflectance">0</float>
					<float name="RightParamA">-0.600000024</float>
					<float name="RightParamB">0.600000024</float>
