...
<?php
  ...
  ?>
	...
	<?php if($row['buywith'] == "tix" && $row['price'] > 0){ ?>
	...
	<div id="EditItemContainer">
		<div id="EditItem">
			...
			<div id="ItemDescription">
				...
				<textarea name="iDesc" maxlength="1000" rows="2" cols="20" class="TextBox" style="height:150px;width: 410px;padding: 5px;"><?=nl2br($row['description'])?></textarea>
			</div>
